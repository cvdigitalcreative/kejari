    ...
    <div class="row">   
      <div class="col-xl-12 mb-30">     
          ...
          <div class="card-body">
            ...
            <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              <tbody>
                ...
                foreach($training->result_array() as $i) {
                    $no++;
                    $training_id = $i['training_id'];
                    $training_nama = $i['training_nama'];
                    $training_tanggal = $i['training_tanggal'];
                  ?>
                  <tr>
                     <td><center><?php echo $no?></center></td>
                      <td><?php echo $training_nama?></td>
                      <td>
                          <a href="#" style="margin-right: 10px; margin-left: 10px;" data-toggle="modal" data-target="#editdata<?php echo $training_id?>"><span class="ti-pencil"></span></a>
                          <a href="#" style="margin-right: 10px" data-toggle="modal" data-target="#hapusdata<?php echo $training_id?>"><span class="ti-trash"></span></a>
                      </td>
                    </tr>
                  <?php }?>
              </tbody>
       ...
       <!-- Modal Add Barang Reseller-->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah training</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <form action="<?php echo base_url()?>Admin/Training/savetraining" method="post" enctype="multipart/form-data">
        ...
        ?>
        <!-- Modal edit Data -->
          <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $training_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="<?php echo base_url()?>Admin/Training/updatetraining" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="control-label">Nama Training</label>
                                    <input type="hidden" name="id" value="<?php echo $training_id?>">
                                    <input class="form-control form-white" type="text" name="nama" value="<?php echo $training_nama?>" required/>
                                </div>
                            </div>          
                    </div>
                    <div class="modal-footer">
        ...
        <?php foreach($training->result_array() as $i) :
                    ...
                    $training_tanggal = $i['training_tanggal'];
                  ?>
        <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $training_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url()?>Admin/Training/hapustraining" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="id" value="<?php echo $training_id?>"/> 
