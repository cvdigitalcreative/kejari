                ...
                <tbody>
                    <?php
                      ...
                      foreach ($data->result_array() as $i) :
                         $no++;
                                   $kategori_id=$i['kategori_tentang_id'];
                                   $kategori_nama=$i['kategori_tentang_nama'];
        ...
        <div class="modal" tabindex="-1" role="dialog" id="add-category">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url().'Admin/Kategori_tentang/simpan_kategori'?>" method="post">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="ModalEdit<?php echo $kategori_id;?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url().'Admin/Kategori_tentang/update_kategori'?>" method="post">
                            <div class="row">
                                <div class="col-md-12">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="ModalHapus<?php echo $kategori_id;?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url().'Admin/Kategori_tentang/hapus_kategori'?>" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="kode" value="<?php echo $kategori_id;?>"/> 
