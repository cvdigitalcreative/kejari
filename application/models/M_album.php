...
class M_album extends CI_Model{
	...
	function simpan_album($album,$user_id,$user_nama){
		$hsl=$this->db->query("INSERT into tbl_album(album_nama,album_pengguna_id,album_author) values ('$album','$user_id','$user_nama')");
		return $hsl;
	}
	...
	function update_album($album_id,$album_nama,$user_id,$user_nama){
